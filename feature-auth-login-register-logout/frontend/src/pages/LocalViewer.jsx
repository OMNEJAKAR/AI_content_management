...
export default function LocalViewer() {
  ...
  return (
    <div>
      ...
      {preview && (
        <div style={{ position: "fixed", top:0, left:0, right:0, bottom:0, background: "rgba(0,0,0,0.7)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999 }} onClick={() => setPreview(null)}>
          <div style={{ background: "#fff", padding: 20, borderRadius: 8, maxWidth: "95%", maxHeight: "95%", overflow: "auto" }} onClick={(e)=>e.stopPropagation()}>
            {preview}
          </div>
        </div>
      )}
